...
# In this code, the __prepare__() method is making
# a special ChainMap mapping that consists of an empty dictionary 
# and a dictionary of all of the defined validators.
# The empty dictionary that's listed first is 
# going to collect all of the definitions made inside the class body.
...
# passes the remaining definitions onto the type constructor.
# It's ingenious, but it lets you drop the annoying imports
